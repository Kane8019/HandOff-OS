...
HandoffOS is a documentation-first project with a small, local-only CLI.

## What HandoffOS does and doesn't do
...
Because of this, the main "security" concern for HandoffOS is **not leaking
